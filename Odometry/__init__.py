...
class XDriveDrivetrainOdometry:
    def __init__(self, motor_1: Motor, motor_2: Motor, motor_3: Motor, motor_4: Motor, track_width_cm: float, wheel_diameter_cm: float, starting_location: tuple = (0, 0, 0)):
        ...
        self._wheel_1_distance_per_second = 0
    ...
    def set_velocities(self, motor_1_rpm: float = None, motor_2_rpm: float = None, motor_3_rpm: float = None,
        ...
        if motor_1_rpm is not None:
            self._wheel_1_distance_per_second = motor_1_rpm / 60 * self._cm_per_wheel_revolution
    ...
    def update_states(self, current_time):
        ...
        self._current_rotation_rad += (-(self._wheel_1_distance_per_second + self._wheel_2_speed_distance_per_second + self._wheel_3_speed_distance_per_second + self._wheel_4_speed_distance_per_second) * delta_time / self._track_width)
        forward_backward_speed = (self._wheel_3_speed_distance_per_second - self._wheel_1_distance_per_second) / 2
